                        ...
                        <>
                            ...
                            <div className="flex flex-col h-full">
                                <div className="flex-1 overflow-y-scroll">
                                    {messages.map((message, index) => (
                                        ...
                                        >
                                          ...
                                          >
                                            <p className={`${index % 2 === 0 ? "text-white" : "text-gray-700"}`}>
                                              {message}
                                            </p>
                                          </div>
                                        </div>
                                ...
                                <form onSubmit={handleSend} className="flex mt-2">
                                    ...
                                    />
                                    <button
                                        className="rounded-r-lg bg-green-500 text-white px-4 py-2 hover:bg-green-600 transition-colors duration-300">
                                      <FormattedMessage
                                          id='Send'
                                          defaultMessage="Default error message"
                                      />
